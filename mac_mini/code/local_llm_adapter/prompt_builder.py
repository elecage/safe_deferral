...
9. 위 규칙 1-8을 충족한 경우에만, device_states와 environmental_context를 명시적으로 활용해 트리거의 의도를 해석하세요. 규칙 1-8에 의해 safe_deferral이 강제되지 않는 한(예: 비상·도어락·민감 장치, 방문자 감지), 충분한 신호가 있으면 safe_deferral보다 actuator catalog 안의 행동을 우선 고려합니다.

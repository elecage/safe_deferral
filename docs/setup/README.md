# safe_deferral 설치 및 설정 가이드 / Setup & Configuration Guide

각 문서는 한국어와 영어를 함께 포함합니다.  
Each document contains both Korean and English.

---

| 문서 / Document | 대상 / Target |
|---|---|
| [01_mac_mini_setup.md](01_mac_mini_setup.md) | Mac mini 운영 허브 Python 모듈 / Mac mini operational hub Python modules |

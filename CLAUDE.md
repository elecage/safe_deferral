...
7. `/common/docs/architecture/17_payload_contract_and_registry.md`
8. `/common/docs/required_experiments.md`
9. `/common/docs/paper/01_paper_contributions.md`
10. `/common/docs/runtime/SESSION_HANDOFF.md`
11. 최신 `SESSION_HANDOFF` addendum 문서들
12. `/README.md`
13. `/CLAUDE.md`
14. `/common/docs/architecture/12_prompts.md`
...
* MQTT-facing 코드, dashboard 코드, governance 코드, experiment 코드 작성 시 `15_interface_matrix.md`, `17_payload_contract_and_registry.md`, `common/mqtt/`, `common/payloads/`와 정합성을 확인할 것
...
* 구현 중 문서와 코드가 충돌하면, 코드에 맞춰 임의 해석하지 말고 먼저 frozen baseline, `13`, `15`, `16`, `17`, `required_experiments.md`를 기준으로 해석할 것
...
8. MQTT-facing 구현에서는 topic registry, publisher/subscriber matrix, topic-payload contract, interface matrix, payload registry와 정합성을 확인한다.
9. governance 구현에서는 UI/backend 분리를 유지하고 Package G verification criteria와 정합성을 확인한다.
...
1. FROZEN 정책/스키마
2. `/common/docs/architecture/13_doorlock_access_control_and_caregiver_escalation.md`
3. `/common/docs/architecture/15_interface_matrix.md`
4. `/common/docs/architecture/17_payload_contract_and_registry.md`
5. `/common/docs/architecture/16_system_architecture_figure.md`
6. `/common/docs/required_experiments.md`
7. `/README.md`
8. `/common/docs/paper/01_paper_contributions.md`
9. `/common/docs/runtime/SESSION_HANDOFF.md` 및 관련 addendum
10. device-layer README와 integration 문서
11. `CLAUDE.md`

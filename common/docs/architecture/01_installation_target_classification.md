...
| **Planned Extension** | Embedded / Physical Node | ESP32 Doorlock / Warning Interface Node | ESP32 device | PlatformIO / Arduino firmware | Physical bounded output node for doorlock or warning actuation beyond the current canonical low-risk catalog |

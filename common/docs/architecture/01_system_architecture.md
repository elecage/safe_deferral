...
- safe deferral and Class 2 clarification coordination (with opt-in scanning interaction mode and one-turn refinement — see `04_class2_clarification.md` §4.4–§4.6),
...
- fault injection,
- experiment orchestration (Package A's four orthogonal comparison dimensions — Class 1 intent recovery, Class 2 candidate generation, Class 2 scanning ordering, Class 2 interaction model — are documented in `04_class2_clarification.md` §4.7),

...
For current architecture, policy/schema, dashboard, experiment, scenario alignment, doorbell, doorlock-sensitive, MQTT, payload, governance, interface-matrix, Mac mini install/configure/verify, Raspberry Pi install/configure/verify, ESP32 install/configure/verify, paper figure revision, and architecture-document-structure work, read in this order:

1. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_SCENARIO_ALIGNMENT_PLAN.md`
2. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_SYSTEM_LAYOUT_FIGURE_REVISION_UPDATE.md`
3. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_ESP32_SCRIPT_ALIGNMENT_UPDATE.md`
4. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_RPI_SCRIPT_ALIGNMENT_UPDATE.md`
5. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_MAC_MINI_INSTALL_CONFIG_VERIFY_ALIGNMENT_UPDATE.md`
6. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_SYSTEM_LAYOUT_FIGURE_REVISION_PLAN.md`
7. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_ESP32_SCRIPT_ALIGNMENT_PLAN.md`
8. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_RPI_SCRIPT_ALIGNMENT_PLAN.md`
9. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_POLICY_SCHEMA_MQTT_PAYLOAD_ALIGNMENT_UPDATE.md`
10. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_MQTT_PAYLOAD_GOVERNANCE_AND_ARCH_DOC_ALIGNMENT_UPDATE.md`
11. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_ARCHITECTURE_DOC_CONSOLIDATION_AND_PAYLOAD_REGISTRY_UPDATE.md`
12. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_DOORBELL_VISITOR_CONTEXT_UPDATE.md`
13. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_DOC_ALIGNMENT_UPDATE.md`
14. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_POLICY_SCHEMA_ALIGNMENT_UPDATE.md`
15. `common/docs/runtime/SESSION_HANDOFF_2026-04-24_DASHBOARD_TEST_APP_AND_ORCHESTRATION_UPDATE.md`
16. `common/docs/runtime/SESSION_HANDOFF_2026-04-24_PROMPT_REFACTOR_AND_EVAL_UPDATE.md`
17. `common/docs/runtime/SESSION_HANDOFF_2026-04-25_MASTER_LEGACY_HANDOFF.md`
...
19. For paper figure work on `system_layout_final_macmini_only_lshape.svg`, check `SESSION_HANDOFF_2026-04-25_SYSTEM_LAYOUT_FIGURE_REVISION_UPDATE.md`; the active figure is now the non-draft SVG under `common/docs/architecture/figures/`.
20. Treat `figures/drafts/` SVGs as review artifacts, not active architecture references.
21. For scenario documentation, skeleton JSON, fixture, or scenario verifier work, check `SESSION_HANDOFF_2026-04-25_SCENARIO_ALIGNMENT_PLAN.md` first and update scenario docs before batch-editing scenario JSON files.
22. Scenario skeletons must move away from legacy `smarthome/...` topics toward the registry-aligned `safe_deferral/...` namespace.
23. Scenario files are evaluation assets and must not redefine frozen policy/schema truth.
